...
public abstract class DynaTime {
    ...
    public DynaTime(long timeInMillis) {
        init(timeInMillis, INTERVAL);
    }

    public DynaTime(long timeInMillis, long intervalInMillis) {
        init(timeInMillis, intervalInMillis);
    }

    /**
     * Function to initialize DynaTime.
     *
    ...
    /**
     * This function check whether the timer is running or not
     *
    ...
    /**
     * Function to check whether the timer is paused.
     *
    ...
    /**
     * Function to be called every second by the {@link DynaTime}
     *
     * @param timeRemaining: Time remaining in milliseconds.
     */
    public abstract void onTimerStart(long timeRemaining);

    /**
     * Function to be called by {@link DynaTime} when the thread is getting finished
     */
